...
const Experiences2 = ({experienceList}) => {
    ...
    return (
        <section className="w-full h-auto flex flex-col items-center justify-center relative lg:px-24 md:px-20 px-6 py-6">
                        ...
                        experienceList.map((card, index) => (
                            ...
                            {index%2==0?
                                <div className="bg-salmon p-6 rounded-lg flex flex-col items-center cursor-pointer transform transition-transform duration-300 hover:scale-105">
                                    <img src={card.imageUrl} alt="Descripción 1" className="w-full h-40 object-cover mb-4 rounded" />
                                ...
                                <div className="bg-redwinee p-6 rounded-lg flex flex-col items-center cursor-pointer transform transition-transform duration-300 hover:scale-105 ">
                                    ...
                                    <img src={card.imageUrl} alt="Descripción 2" className="w-full h-40 object-cover mb-4 rounded" />
                                </div>
                            }
                            </Link>
                        ))
